...
public class ScheduleEditorValidator implements IUiValidator {
  ...
  public ScheduleEditorValidator( ScheduleEditor scheduleEditor ) {
    ...
    this.recurrenceEditorValidator = new RecurrenceEditorValidator( this.scheduleEditor );
    this.runOnceEditorValidator = new RunOnceEditorValidator( this.scheduleEditor );
